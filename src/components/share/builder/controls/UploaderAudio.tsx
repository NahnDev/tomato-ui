...
import { faFileAudio, faFileImage, faImage, faTrash, faUpload } from "@fortawesome/free-solid-svg-icons";

export default function UploaderAudio(props: ControlProps) {
  ...
  return (
    <div className="w-full h-full grid grid-rows-[1fr_auto] border-2 border-slate-200 rounded-md">
      <div {...getRootProps()} className="flex justify-center items-center w-full h-full">
        <input {...getInputProps()} />
        <FontAwesomeIcon className="text-[3em] opacity-25" icon={faFileAudio} />
